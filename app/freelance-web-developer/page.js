...
import WebDevAnimations from "./WebDevAnimations";
          ...
          <div className="relative flex items-center justify-center w-full mt-12 lg:mt-0">
            <div className="relative w-[312px] h-[422px] sm:w-[384px] sm:h-[520px] lg:w-[480px] lg:h-[650px] mx-auto">
              <div className="absolute top-0 left-0 w-[480px] h-[650px] scale-[0.65] sm:scale-[0.8] lg:scale-100 origin-top-left">
                ...
                >
                  <Image src="/assets/trasccon.webp" alt="High-trust defence manufacturing website developed by freelance web developer for Trasccon" width={460} height={260} priority sizes="(max-width: 768px) 100vw, 460px" quality={80} className="w-full h-full object-cover object-top" />
                </div>
                ...
                >
                  <Image src="/assets/leadworks.webp" alt="Premium custom website developed in Next.js for Leadworkz digital marketing agency" width={460} height={260} priority sizes="(max-width: 768px) 100vw, 460px" quality={80} className="w-full h-full object-cover object-top" />
                </div>
                ...
                >
                  <Image src="/assets/rain-country.webp" alt="SEO-focused hospitality website design driving organic bookings for Rain Country resorts" width={460} height={260} sizes="(max-width: 768px) 100vw, 460px" quality={80} className="w-full h-full object-cover object-top" />
                </div>
                ...
                >
                  <Image src="/assets/navodaya.webp" alt="Conversion-focused B2B industrial website developed for Navodaya Power" width={460} height={260} sizes="(max-width: 768px) 100vw, 460px" quality={80} className="w-full h-full object-cover object-top" />
                </div>
              </div>
            </div>
          </div>
